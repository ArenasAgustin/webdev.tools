...
export const JsonPathHistoryModal = memo(function JsonPathHistoryModal({
  isOpen,
  history,
  onClose,
  onReuse,
  ...
  return (
    ...
    >
      <div className="space-y-2 max-h-[50vh] overflow-y-auto scrollbar-thin">{renderedHistory}</div>
    </Modal>
  );
});
